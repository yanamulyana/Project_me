...
<aside class="right-side">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="voucher.php"><i class="fa fa-dashboard"></i> Voucher</a></li>
		</ol>
	</section>
	...
	<section class="content">
		{if $msg == '1'}
			<p style="color: #5cb85c;">Voucher berhasil diubah.</p>
		{/if}
		<form method="POST" action="voucher.php?mod=voucher&act=update">
